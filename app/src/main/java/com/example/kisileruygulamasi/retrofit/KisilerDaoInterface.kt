...
interface KisilerDaoInterface {
    ...
    //web sevice den GET ile veri cekmek icin olusturduk bu sinifi
    //ve fun tumkisiler ile  entity->kisilerCevap dan liste cekiliyor
    ...
    @POST("kisiler/kisiler/tum_kisiler_arama.php")
    @FormUrlEncoded
